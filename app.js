...
// Use every() to determine if every person is 19 or older
isEveryone19OrOlder = devs.every(dev => newYear - dev.year >= 19);

console.log(isEveryone19OrOlder); // true or false
// Check your work:
...
commentById = comments.find(commet => comments.id === 823423)
